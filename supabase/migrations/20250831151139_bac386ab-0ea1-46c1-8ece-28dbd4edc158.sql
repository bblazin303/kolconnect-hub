-- Update the handle_new_user function to better handle user_type detection
...
BEGIN
  ...
  user_type_val := COALESCE(
    ...
    NEW.raw_user_meta_data->>'custom_claims'->>'user_type', -- Custom claims
  ...
  VALUES (
    ...
    COALESCE((NEW.raw_user_meta_data->>'public_metrics'->>'followers_count')::integer, 
             (NEW.raw_user_meta_data->>'public_metrics_followers_count')::integer, 0),
